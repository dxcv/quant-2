...
class XcFactorBuyMean(AbuFactorBuyBase, BuyCallMixin):
    ...
    def fit_day(self, today):
        ...
        # 收盘价小于xd个bar内最高价*(1-range)，且下跌幅度较小，则买入
        if today.close < self.kl_pd.high[self.today_ind - self.xd + 1:self.today_ind + 1].max()*(1-(self.range/100)):
